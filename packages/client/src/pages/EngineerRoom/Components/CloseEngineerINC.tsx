...
import { AddValuesProps, CloseEngineerINCProps } from '../interfaces'
...
export const CloseEngineerINC = memo(
  React.forwardRef<unknown, CloseEngineerINCProps>(
    (
      {
        handleModal,
        title,
      ...
      return (
        <BoxModal
          ...
          <ButtonsModalSection
            ...
            closeModal={() => handleModal({ state: false })}
            btnName={'Сохранить'}
